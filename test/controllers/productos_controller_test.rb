...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { estado: @producto.estado, nombre: @producto.nombre, sku: @producto.sku, stock_critico: @producto.stock_critico, stock_minimo: @producto.stock_minimo, umedida_id: @producto.umedida_id }
    end
  ...
  test "should update producto" do
    patch :update, id: @producto, producto: { estado: @producto.estado, nombre: @producto.nombre, sku: @producto.sku, stock_critico: @producto.stock_critico, stock_minimo: @producto.stock_minimo, umedida_id: @producto.umedida_id }
    assert_redirected_to producto_path(assigns(:producto))
  end
